...
<div style={{ display: 'flex', alignItems: 'center' }}>
  ...
  <div>
    ...
    am a software engineer at Credit Suisse APAC Wealth Management (WM)
    Technology. Together with Noorul and Benedita, I work on Digital Private
    Banking (DPB) software.
  </div>
</div>
