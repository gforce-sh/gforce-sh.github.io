...
<div style={{ display: 'flex', alignItems: 'center' }}>
  ...
  <div>
    My name is Gaurav, I graduated from NUS with a Bachelor's in Engineering in
    2016 and Master's in Computer Science in 2022. I am a software engineer at
    Credit Suisse APAC Wealth Management Technology. Together with Noorul and
    Benedita, I work on Digital Private Banking software.
  </div>
</div>
