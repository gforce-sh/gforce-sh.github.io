...
<div style={{ display: 'flex', alignItems: 'center' }}>
  ...
  <div>
    My name is Gaurav, I graduated from NUS in 2016, and then again in 2022. I
    am a software engineer at Credit Suisse APAC Wealth Management Technology.
    Together with Noorul and Benedita, I work on Digital Private Banking
    software.
  </div>
</div>
